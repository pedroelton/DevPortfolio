...
const ContactForm = () => {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_s4rkg7c', 'template_xz5bezg', e.target, '0WdidzAPt9WOvuTQu')
    .then((result) => {
  ...
  return (
  <div className="flex flex-col p-6 rounded-xl bg-transparent border-2 border-orange-300 w-full bg-orange-200">
    <form onSubmit={sendEmail}>
      ...
      <button type="submit" className="
        ...
        transition
        duration-150
        ease-in-out">Send my message</button>
    </form>
  </div>
  )
}
