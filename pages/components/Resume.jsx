		...
		>
			...
			<div className="flex flex-col space-y-5 md:w-[50vw] w-full md:px-0">
				...
				<p className="text-zinc-600 md:w-[540px] leading-relaxed md:text-lg text-md font-light text-left">
					I gathered experience in different areas of design, development,
					marketing and management and it’s an asset, since this broad vision
					helps me to develop better solutions. I can add value for your company
					by adding to my work the following skills:
				</p>
				<ul>
					<ListTopics
						icon="check"
				...
				<p className="text-zinc-600 md:w-[540px] leading-relaxed md:text-lg text-md text-left">
					...
					>
						Why not book an interview with me here?
					</a>
